    ...
    <>
      <HeaderStyled>
        <div>
          Nossa Missão:
          <p>
            “Reunir as galerias do Brasil inteiro em um só lugar <br /> e
            possibilitar o acesso de suas obras".{" "}
          </p>
        </div>
        ...
        <div>
          ...
          <p>
            {" "}
            <InstaIcon /> /artes_mira{" "}
          </p>
          <p>
            {" "}
            <TelegramIcon /> (21) 91234-1234{" "}
          </p>
          <p>
            {" "}
            <WhatsIcon /> (21) 91234-1234{" "}
          </p>
        </div>
        ...
        <div>
          ...
          <p>
            {" "}
            <EmailIcon /> artes_mira@mira.com.br{" "}
          </p>
        </div>
      </HeaderStyled>
    </>
